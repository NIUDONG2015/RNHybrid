 ...
 */
public class RecyStickLayoutFragment extends TestBaseFragment implements StickyHeadContainer.DataCallback {
    ...
    protected void initView(View view) {
        ...
        mAdapter = new StockAdapter(null, mContext);
