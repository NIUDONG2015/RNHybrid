...
public class RefreshRecyclerView extends RecyclerView {
    ...
    private void initHeaderView() {
        mHeaderView = (ViewGroup) inflate(getContext(), R.layout.rv_header, null);
        ...
        defaultHeader = (LinearLayout) mHeaderView.findViewById(R.id.default_header);
    ...
    private void initFooterView() {
        mFooterView = inflate(getContext(), R.layout.rv_footer, null);
        //测量
