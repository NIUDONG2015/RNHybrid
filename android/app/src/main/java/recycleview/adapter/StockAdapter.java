...
public class StockAdapter extends RecyclerView.Adapter<RecyclerViewHolder> {
    ...
    public StockAdapter(List<StickyHeadEntity<StockEntity.StockInfo>> datas, Context mContext) {
        this.mData = datas;
    ...
    public void setData(List<StickyHeadEntity<StockEntity.StockInfo>> list) {
        this.mData = list;
