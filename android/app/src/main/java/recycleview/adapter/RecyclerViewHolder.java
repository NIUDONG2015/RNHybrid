...
public class RecyclerViewHolder extends RecyclerView.ViewHolder {
    ...
    public void setLayoutView( boolean isWebView) {
        if (isWebView) {
            MyUtil.setVisibility((LinearLayout) getView(R.id.web_view_root_layout), View.VISIBLE);
            MyUtil.setVisibility((LinearLayout) getView(R.id.data_layout), View.GONE);
        } else {
            MyUtil.setVisibility((LinearLayout) getView(R.id.web_view_root_layout), View.GONE);
            MyUtil.setVisibility((LinearLayout) getView(R.id.data_layout), View.VISIBLE);
        }
