...
/**
 * Created by niudong on 2017/6/6.
 */

public class StickyItemLayoutDecoration extends RecyclerView.ItemDecoration {
    ...
    public StickyItemLayoutDecoration(StickyHeadContainer stickyHeadContainer, int stickyHeadType) {
