 ...
 * 只需要设置图片  然后设置进度就行customview.AroundCircleView
 * 圆角显示图片  来自CircleImageView
 * 在基础上修改
 * Created by niudong on 2017/2/28.
 */
public class AroundCircleView extends ImageView {
    ...
    public AroundCircleView(Context context, AttributeSet attrs, int defStyle) {
        ...
        //边框宽app:textSize="10dp" 宽度0时不显示
        mBorderWidth = a.getDimensionPixelSize(
                R.styleable.AroundCircleView_textSizeAc, DEFAULT_BORDER_WIDTH);

        // app:textColor 外围进度条的颜色
        mBorderColor = a.getColor(R.styleable.AroundCircleView_textColorAc,
